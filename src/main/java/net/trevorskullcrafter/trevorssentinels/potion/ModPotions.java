...
public class ModPotions {
    ...
    public static Potion registerPotion(String name){
        return Registry.register(Registries.POTION, new Identifier(trevorssentinels.MOD_ID, name),
                new Potion(new StatusEffectInstance(ModEffects.REDSTONED, 1000, 0)));
    }

    public static void registerPotions(){
        trevorssentinels.LOGGER.info("Registering potions... (" + MOD_ID + ")");
        REDSTONED_POTION = registerPotion("redstoned_potion");
    }
}