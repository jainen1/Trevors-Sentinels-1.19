...
public class EnglishLangGenerator extends FabricLanguageProvider {
    ...
    public void generateMisc(TranslationBuilder translationBuilder){
        translationBuilder.add("color.rarity.minecraft.uncommon", yellow);
        translationBuilder.add("color.rarity.minecraft.rare", aqua);
        translationBuilder.add("color.rarity.minecraft.epic", green);
        ...
        generateNumbered(translationBuilder, "color."+MOD_ID+".worldLevelTooLow.", "", light_purple, blue);
        ...
        generateSetBonus(translationBuilder, ModArmorMaterials.GUNMETAL, "Set Bonus: Night Vision", sentiBlue);
        ...
        generateNumbered(translationBuilder, "style.item." + MOD_ID + ".hard_light_projector.", "Deploy", "Recall", "Unbind");
    }
    ...
    @Override public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        generateItem(translationBuilder, ModItems.SALT, 0, null, "Used for keeping meat fresh.", "2_#fbebe5_#f7d2c5");
        ...
        generateItem(translationBuilder, ModItems.SMOKED_FISH, 0, null, null, "2_#beab27_#47320e");
        ...
        generateItem(translationBuilder, ModItems.GALINITE_LENS, 0, null, "Use on certain blocks and entities to gather data on them!", sentiBlue);
        generateItem(translationBuilder, ModItems.HARD_LIGHT_PROJECTOR, 0, "Hard Light Projector", null, sentiBlue);
        ...
        generateItem(translationBuilder, ModEffectItems.DOLPHINS_GRACE_ITEM, 0, "Squishy Foam Dolphin",
                "Its silky skin makes you feel hydrodynamic.", "2_#cddced_#577391");
        ...
        generateItem(translationBuilder, ModItems.VENDOR_TOKEN, 0, null, null, "2_#a2afb1_#6b7779");
        ...
        generateItem(translationBuilder, ModBlocks.DATA_BLOCK, 0, null, null, sentiBlue);
        generateItem(translationBuilder, ModBlocks.BLUE_AGILITY_BLOCK, 0, null, null, sentiBlue);
        ...
        generateItem(translationBuilder, ModBlocks.HARD_LIGHT, 0, null, null, sentiBlue);
        generateItem(translationBuilder, ModBlocks.HARD_LIGHT_BARRIER, 0, null, "Creative only!", sentiRed);
    ...
    public static final String sentiBlue = "#189DBB";
    public static final String sentiRed = "#D31400";
    public static final String galliumGray = "#64666b";

    public static final String scrap = "#ac4313";
    ...
    public static final String imperial_alloy = "#eae69b"; //#a78442
    public static final String blood_red = "#9e000d"; //#d90012
    public static final String nuclear = "#47fa0c";

    public static final String yggdrasil = "#eae1e5";
    public static final String charred = gray;
    public static final String midas = "#beab27";
    public static final String viridescent = "#75892e";
    public static final String cerulii = "#117bcd";

    public static final String tranquil = "#9949f2";
    public static final String skullweed = "1_#807bad_#6c5ca1";
    public static final String chorus = "1_#ba9bba_#a381a2";
    public static final String pearfruit = "#d4ff1c";
    ...
    public static final String snowstone = "#f0fdfd";
    ...
    public static Text getColoredText(String textContent, String color) {
        if (color != null) { return getStyledText(textContent, Style.EMPTY.withColor(TextColor.parse(color))); }
        return getStyledText(textContent, Style.EMPTY);
    }

    public static Text getStyledText(String textContent, Style styleContent) {
        return new Text() {
            private final TextContent content = new TranslatableTextContent(textContent, null, null);
    ...
    public static Formatting quotientToolTipFormatting(double dividend, double divisor, Formatting fallback, Formatting... formattings) {
        int test = (int) Math.floor((dividend * formattings.length-1) / divisor);
        return test >= 0? formattings[test] : fallback;
    }

    //Returns the default Formatting based on the dividend / divisor.
    public static Formatting quotientToolTipFormatting(double dividend, double divisor) {
        return quotientToolTipFormatting(dividend, divisor, Formatting.GRAY, Formatting.RED, Formatting.YELLOW, Formatting.GREEN, Formatting.AQUA, Formatting.LIGHT_PURPLE);
    }
    ...
    public void generateColor(TranslationBuilder translationBuilder, ItemConvertible item, int custom, String color){
        translationBuilder.add("color." + getItemKey(item) + (custom != 0? (".custom" + custom) : ""), color);
    }
    ...
    public void generateMultiple(@NotNull TranslationBuilder translationBuilder, int custom, String color, ItemConvertible... items){
