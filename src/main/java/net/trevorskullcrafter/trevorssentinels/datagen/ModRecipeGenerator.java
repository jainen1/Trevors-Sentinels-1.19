...
public class ModRecipeGenerator extends FabricRecipeProvider {
    ...
    @Override public void generate(RecipeExporter exporter) {
        offerReversibleCompactingRecipes(exporter, RecipeCategory.MISC, ModItems.TORBERNITE_CUBE, RecipeCategory.BUILDING_BLOCKS, ModBlocks.NUCLEAR_BLOCK);
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(Items.IRON_INGOT), Ingredient.ofItems(Items.COPPER_INGOT), Ingredient.ofItems(Items.IRON_INGOT), RecipeCategory.MISC, ModItems.COPPER_IRON_INGOT)
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.empty(), Ingredient.ofItems(Items.IRON_INGOT), Ingredient.ofItems(Items.COPPER_INGOT), RecipeCategory.MISC, ModItems.COPPER_IRON_INGOT)
                .criterion(FabricRecipeProvider.hasItem(Items.IRON_INGOT), FabricRecipeProvider.conditionsFromItem(Items.IRON_INGOT))
                .criterion(FabricRecipeProvider.hasItem(Items.COPPER_INGOT), FabricRecipeProvider.conditionsFromItem(Items.COPPER_INGOT))
                .offerTo(exporter, new Identifier("iron_copper"));
        SmithingTransformRecipeJsonBuilder.create(Ingredient.empty(), Ingredient.ofItems(Items.GOLD_INGOT), Ingredient.ofItems(Items.IRON_INGOT), RecipeCategory.MISC, ModItems.IMPERIAL_ALLOY_INGOT)
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.empty(), Ingredient.ofItems(Items.IRON_INGOT), Ingredient.ofItems(Items.GOLD_INGOT), RecipeCategory.MISC, ModItems.IMPERIAL_ALLOY_INGOT)
                .criterion(FabricRecipeProvider.hasItem(Items.IRON_INGOT), FabricRecipeProvider.conditionsFromItem(Items.IRON_INGOT))
                .criterion(FabricRecipeProvider.hasItem(Items.GOLD_INGOT), FabricRecipeProvider.conditionsFromItem(Items.GOLD_INGOT))
                .offerTo(exporter, new Identifier("iron_gold"));
        SmithingTransformRecipeJsonBuilder.create(Ingredient.empty(), Ingredient.ofItems(Items.COPPER_INGOT), Ingredient.ofItems(Items.GOLD_INGOT), RecipeCategory.MISC, ModItems.ROSE_GOLD_INGOT)
                .criterion(FabricRecipeProvider.hasItem(Items.COPPER_INGOT), FabricRecipeProvider.conditionsFromItem(Items.COPPER_INGOT))
                .criterion(FabricRecipeProvider.hasItem(Items.GOLD_INGOT), FabricRecipeProvider.conditionsFromItem(Items.GOLD_INGOT))
                .offerTo(exporter, new Identifier("copper_gold"));
        SmithingTransformRecipeJsonBuilder.create(Ingredient.empty(), Ingredient.ofItems(Items.GOLD_INGOT), Ingredient.ofItems(Items.COPPER_INGOT), RecipeCategory.MISC, ModItems.ROSE_GOLD_INGOT)
                .criterion(FabricRecipeProvider.hasItem(Items.GOLD_INGOT), FabricRecipeProvider.conditionsFromItem(Items.GOLD_INGOT))
                .criterion(FabricRecipeProvider.hasItem(Items.COPPER_INGOT), FabricRecipeProvider.conditionsFromItem(Items.COPPER_INGOT))
