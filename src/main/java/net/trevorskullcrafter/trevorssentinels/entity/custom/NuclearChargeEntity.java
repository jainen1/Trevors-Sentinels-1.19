...
public class NuclearChargeEntity extends Entity {
    private static final TrackedData<Integer> FUSE;
    private static final int DEFAULT_FUSE = 80;
    @Nullable
    private LivingEntity causingEntity;

    public NuclearChargeEntity(EntityType<? extends NuclearChargeEntity> entityType, World world) {
        super(entityType, world);
        this.intersectionChecked = true;
    }

    /*public NuclearChargeEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter) {
        this(ModEntities.SENTINEL, world);
    ...
    static {
        FUSE = DataTracker.registerData(NuclearChargeEntity.class, TrackedDataHandlerRegistry.INTEGER);
    }
}