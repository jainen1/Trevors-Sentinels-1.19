...
public class ModSwordItem extends SwordItem {
    ...
    public String color;
    public Text name;
    public ModSwordItem(String color, ToolMaterial material, int attackDamage, float attackSpeed, Item.Settings settings) {
        super(material, attackDamage, attackSpeed, settings);
        this.color = color;
        this.doDashes = false;
    }

    public ModSwordItem(String color, boolean doDashes, ToolMaterial material, int attackDamage, float attackSpeed, Item.Settings settings) {
        super(material, attackDamage, attackSpeed, settings);
        this.color = color;
