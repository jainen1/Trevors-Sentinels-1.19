...
public class ModAxeItem extends AxeItem {
    ...
    public String color;
    public Text name;
    public ModAxeItem(String color, ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
        super(material, attackDamage, attackSpeed, settings);
        this.color = color;
        this.doDashes = false;
    }

    public ModAxeItem(String color, boolean doDashes, ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
        super(material, attackDamage, attackSpeed, settings);
        this.color = color;
