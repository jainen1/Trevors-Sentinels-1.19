...
public class ModHoeItem extends HoeItem {
    ...
    public String color;
    public Text name;
    public ModHoeItem(String color, ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
        super(material, attackDamage, attackSpeed, settings);
        this.color = color;
        this.doDashes = false;
    }

    public ModHoeItem(String color, boolean doDashes, ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
        super(material, attackDamage, attackSpeed, settings);
        this.color = color;
