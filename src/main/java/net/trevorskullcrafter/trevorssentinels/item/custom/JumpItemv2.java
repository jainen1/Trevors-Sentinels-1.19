            ...
            if(stack.getSubNbt("trevorssentinels:power") != null && Objects.requireNonNull(stack.getSubNbt("trevorssentinels:power"))
                ...
                if (world.getTime() > cooldownTime) {
                    if (Screen.hasShiftDown()) {
                        ...
                        if (jumpTime >= 20) {
                            if(world.isClient()) world.playSound((PlayerEntity) entity, entity.getX(), entity.getY(), entity.getZ(),
                    ...
                    if(FlightStatusEffect.hasSpacebarDown() && !entity.isOnGround()){
                        ...
                        }else ((PlayerEntity) entity).sendMessage(Text.literal("Out of fuel!").formatted(Formatting.RED), true);
                    }

                } else {
                    if (world.isClient) if (((cooldownTime - world.getTime()) & 20) == 0) world.playSound((PlayerEntity) entity, entity.getX(),
                            entity.getY(), entity.getZ(), SoundEvents.BLOCK_FIRE_EXTINGUISH, SoundCategory.PLAYERS, ((float) (cooldownTime - world.getTime()) / 200), 0.0f);
                }
