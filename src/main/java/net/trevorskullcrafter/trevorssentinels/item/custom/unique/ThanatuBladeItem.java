            ...
            if (StyleUtil.getStyle(itemStack) == 1) {
                if (user.isSneaking()) {
                    ...
                    timePercent = (int) (Objects.requireNonNull(itemStack.getSubNbt("trevorssentinels:timerHolder"))
                            .getLong("trevorssentinels:timer") - world.getTime()) / 2;
                    ...
                    world.playSound(null, user.getBlockPos(), SoundEvents.ENTITY_WARDEN_SONIC_CHARGE, SoundCategory.BLOCKS, 2.0F, 2.0F);
                    ...
                    if (itemStack.getSubNbt("trevorssentinels:harmoniousTeleportData") != null) { user.requestTeleportAndDismount(
                        ...
                        world.playSound(null, user.getBlockPos(), SoundEvents.ENTITY_WARDEN_SONIC_BOOM, SoundCategory.BLOCKS, 2.0f, 2.0f);
                ...
                world.playSound(null, user.getBlockPos(), SoundEvents.BLOCK_END_PORTAL_SPAWN, SoundCategory.BLOCKS, 0.5f, 1.0f);
