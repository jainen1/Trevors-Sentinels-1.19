...
public class MorpheusBladeItem extends SwordItem {
    public MorpheusBladeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
