...
public class PappyMSwordItem extends SwordItem {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.literal("Balance").formatted(Formatting.ITALIC));
            tooltip.add(Text.literal("Right click to parry!").formatted(Formatting.GREEN));
            tooltip.add(Text.literal("Shift + right click to become energized!").formatted(Formatting.DARK_GREEN));
    }
}
