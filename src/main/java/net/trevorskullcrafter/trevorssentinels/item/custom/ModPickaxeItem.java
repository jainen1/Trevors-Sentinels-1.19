...
public class ModPickaxeItem extends PickaxeItem {
    ...
    public String color;
    public Text name;
    public ModPickaxeItem(String color, ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
        super(material, attackDamage, attackSpeed, settings);
        this.color = color;
        this.doDashes = false;
    }

    public ModPickaxeItem(String color, boolean doDashes, ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
        super(material, attackDamage, attackSpeed, settings);
        this.color = color;
