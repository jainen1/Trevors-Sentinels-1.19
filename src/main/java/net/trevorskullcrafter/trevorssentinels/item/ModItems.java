...
public class ModItems {
    public static final Item SENTINUM_SHARD = registerItem("sentinum_shard", new NamedItem(flimsy_sentinum, new FabricItemSettings()));
    public static final Item SENTINUM_INGOT = registerItem("sentinum_ingot", new NamedItem(flimsy_sentinum, new FabricItemSettings()));
    ...
    public static final Item ROSE_GOLD_INGOT = registerItem("rose_gold_ingot", new NamedItem(rose_gold, new FabricItemSettings()));
    public static final Item IRON_GOLD_INGOT = registerItem("iron_gold_ingot", new NamedItem(iron_gold, new FabricItemSettings()));
    public static final Item TRANSITITE_SHARDS = registerItem("transitite_shards", new NamedItem(demonic, new FabricItemSettings()));
    public static final Item ASH = registerItem("ash", new NamedItem("8_"+darksteel_RAW, new FabricItemSettings()
            .food(new FoodComponent.Builder().hunger(-2).saturationModifier(0.2f).build())));
    public static final Item DARKSTEEL_INGOT = registerItem("darksteel_ingot", new NamedItem(darksteel, new FabricItemSettings()));
    public static final Item REDSTONE_CRYSTAL = registerItem("redstone_crystal", new NamedItem(blood_red, new FabricItemSettings()));
    public static final Item BLOOD_DIAMOND = registerItem("blood_diamond", new NamedItem(blood_red, new FabricItemSettings().fireproof()));
    public static final Item VIOLENT_CATALYST = registerItem("violent_catalyst", new NamedItem("3_#55FFFF_#55FF55_#FF5555",
            new FabricItemSettings().fireproof()));
    public static final Item FERRAURIUM_DARKSTEEL_INGOT = registerItem("ferraurium_darksteel_ingot", new NamedItem(hallucium, new FabricItemSettings()));
    public static final Item URANIUM_CRYSTAL = registerItem("uranium_crystal", new NamedItem(nuclear, new FabricItemSettings()));
    ...
    public static final Item NUCLEAR_ROCKET = registerItem("nuclear_rocket", new NuclearFireworkItem(
            new FabricItemSettings().maxCount(1).maxDamage(65).rarity(Rarity.RARE)));

    public static final Item MUSIC_DISC_ASSASSINATION_UPLOAD = registerItem("music_disc_assassination_upload", new ModMusicDiscItem
            (7, ModSounds.ASSASSINATION_UPLOAD, new FabricItemSettings().maxCount(1).rarity(Rarity.RARE), 190));
    public static final Item MUSIC_DISC_ODE_TO_TRANQUILITY = registerItem("music_disc_ode_to_tranquility", new ModMusicDiscItem
            (7, ModSounds.ODE_TO_TRANQUILITY, new FabricItemSettings().maxCount(1).rarity(Rarity.RARE), 80));
    public static final Item MUSIC_DISC_LAPSE_IN_JUDGEMENT = registerItem("music_disc_lapse_in_judgement", new ModMusicDiscItem
            (7, ModSounds.LAPSE_IN_JUDGEMENT, new FabricItemSettings().maxCount(1).rarity(Rarity.RARE), 142));
    public static final Item MUSIC_DISC_RECITAL = registerItem("music_disc_recital", new ModMusicDiscItem
    ...
    public static final Item PEARFRUIT = registerItem("pearfruit", new NamedItem("#d4ff1c", new FabricItemSettings()
    ...
    public static final Item BROWNIE = registerItem("brownie", new Item(new FabricItemSettings()
            .food(new FoodComponent.Builder().hunger(5).saturationModifier(0.6f).build())));
    public static final Item SANDFISH = registerItem("sandfish", new NamedItem(dune_tan, new FabricItemSettings()
            .food(new FoodComponent.Builder().hunger(2).saturationModifier(0.6f).build())));
    public static final Item COOKED_SANDFISH = registerItem("cooked_sandfish", new NamedItem(dune_tan, new FabricItemSettings()
            .food(new FoodComponent.Builder().hunger(5).saturationModifier(0.6f).build())));
    public static final Item DUNE_EEL = registerItem("dune_eel", new NamedItem(dune_tan, new FabricItemSettings()
            .food(new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).build())));
    public static final Item ANTIMILK = registerItem("antimilk", new ChaddBucketItem(rainbow, new FabricItemSettings().rarity(Rarity.EPIC)));
    ...
    public static final Item ROOMBA_SPAWN_EGG = registerItem("roomba_spawn_egg",
            new SpawnEggItem(ModEntities.SENTINUM_ROOMBA, 0xffffff, 0xffffff, new FabricItemSettings()));
    ...
    public static final Item JUMP_DRIVE = registerItem("jump_drive", new JumpItemv2(gunmetal, ModArmorMaterials.TRIMETAL, EquipmentSlot.CHEST,
            new FabricItemSettings().maxDamage(100)));
    public static final Item JETPACK = registerItem("jetpack", new JetpackItem(blood_red, ModArmorMaterials.URANIUM, EquipmentSlot.CHEST,
            new FabricItemSettings().maxDamage(100)));
    public static final Item PORTKEY = registerItem("portkey", new PortkeyItem(demonic, true, new FabricItemSettings().maxDamage(11)));
    public static final Item DISTANCE_TRACKER = registerItem("distance_tracker", new DistanceTrackerItem("8_#30194c_#686868",
            new FabricItemSettings().maxCount(1)));

    public static final Item VENDOR_TOKEN = registerItem("vendor_token", new NamedItem("8_#a2afb1_#6b7779", new FabricItemSettings()));
    public static final Item LEGENDARY_TOKEN = registerItem("legendary_token", new NamedItem(rainbow, new FabricItemSettings()));

    public static final Item SUPERFORGE_ITEM = registerItem("superforge_item", new SuperforgeItem(ModBlocks.SUPERFORGE, new FabricItemSettings().fireproof()));
