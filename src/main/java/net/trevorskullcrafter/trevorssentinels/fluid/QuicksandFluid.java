...
public abstract class QuicksandFluid extends FlowableFluid {
    ...
    @Override protected int getFlowSpeed(WorldView world) { return 3; }
    ...
    @Override public int getLevel(FluidState state) { return 0; }
    ...
    @Override public Fluid getStill() { return ModFluids.QUICKSAND_STILL; }
    @Override public Fluid getFlowing() { return ModFluids.QUICKSAND_FLOWING; }
    @Override public Item getBucketItem() { return ModFluids.QUICKSAND_BUCKET; }
    @Override protected BlockState toBlockState(FluidState state) { return ModFluids.QUICKSAND_BLOCK.getDefaultState().with(Properties.LEVEL_8, getBlockStateLevel(state)); }
