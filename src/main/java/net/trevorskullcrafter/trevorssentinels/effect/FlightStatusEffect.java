...
public class FlightStatusEffect extends StatusEffect {
    public FlightStatusEffect(StatusEffectCategory statusEffectCategory, int color) { super(statusEffectCategory, color); }

    public boolean canApplyUpdateEffect(int duration, int amplifier) { return true; }

    public static boolean hasSpacebarDown() { return InputUtil.isKeyPressed(MinecraftClient.getInstance().getWindow().getHandle(), 32); }
    ...
    public void applyUpdateEffect(LivingEntity entity, int amplifier) {
        ...
        if (entity instanceof PlayerEntity) {
            ...
            if(hasSpacebarDown()){
                ...
                entity.setVelocity(entity.getVelocity().x, 0, entity.getVelocity().z); entity.fallDistance = 0.0f;
            }
